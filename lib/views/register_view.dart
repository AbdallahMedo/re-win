...
class _RegisterViewState extends State<RegisterView> {
  ...
  void _register() async {
    ...
    User? user =
        await _authServices.signUp(firstName, lastName, phone, password);
    if (user != null) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => RecycleApp(firstName: firstName,lastName: lastName,phoneNumber: phone,),
        ),
      );
    }else
    {
      Fluttertoast.showToast(msg: "Errrrrrrrrrror");
    }
  }
